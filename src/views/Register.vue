...
<!-- Sidebar end=============================================== -->
	...
	<form class="form-horizontal" >
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="inputFname1" placeholder="Your Name">
			</div>
		 </div>
		<div class="control-group">
	...
	<div class="alert alert-block alert-error fade in">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text"  name="phone" id="phone" placeholder="Phone Number"/> <span>You must register at least one phone number</span>
			</div>
		</div>
